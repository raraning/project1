...
<script>
	...
	function overlapid(){
		...
		if(!joinid.value){
			...
			location.href="overlap_id.jsp?joinid="+olid.value+"&nickname="+olnick.value+"&membername="+name.value+"&birth="+birth.value+"&email="+email.value;
		}
	...
	function overlapnick(){
		...
		if(!joinid.value){
			...
			location.href="overlap_nick.jsp?joinid="+olid.value+"&nickname="+olnick.value+"&membername="+name.value+"&birth="+birth.value+"&email="+email.value;
		}
...
<div height=20>&nbsp;</div>
<div width=100%>
	<form action="join_insert.jsp?id_ok=<%=id_ok%>&nick_ok=<%=nick_ok%>" method="post" onsubmit="return join_ok()">
