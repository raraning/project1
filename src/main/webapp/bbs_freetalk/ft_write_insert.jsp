...
String sql = "insert into notice (id,name,nickname,level,gongji,subject,comment,signdate,file1,file1_o,file1_s) values('"+session_id+"','"+session_name+"','"+session_nickname+"','"+session_level+"','"+gongji+"','"+subject+"','"+comment+"','"+today+"','"+file1_rename+"','"+file1_name+"','"+thum_img+"')";
