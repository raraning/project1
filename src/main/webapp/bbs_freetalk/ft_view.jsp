...
//게시물 수
String sql_c = "select count(*) as comment_count from comment where tb_table='notice' and tb_uid = "+uid;
...
<input type="hidden" id="uid" name="uid">
	...
	<div class="ftw f4">
		...
		<div class="ftwr l4" >
				<%if(!file1.equals("")){%>
					<img src="/upload/<%=file1%>" style="max-width:200px; height:auto"><br>
				<%}%>
				<%
				//comment 개행처리
	...
	<div class="viewfid">
		...
		<div class="fid1">
			...
			<div class="fidv v4">
			<%
			if(session_nickname != null && session_nickname != "" && session_nickname.equals(c_nickname) || session_nickname.equals("관리자")){%>
		...
		<%}else{%>
		<form action="ft_comment_insert.jsp?code=<%=code%>" method="post">
