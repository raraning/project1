...
<div style="text-align:center">
	<div class="join_button1" style="display:inline-block;"><a href="/admin/bbs_freetalk/ft_list.jsp">잡담게시판 바로가기</a></div>
	<div class="join_button1" style="display:inline-block;"><a href="/admin/bbs_img/list.jsp?code=gallery">갤러리게시판 바로가기</a></div>
</div>
<div style="height:15px;"> </div>
...
<script>
	function bbsdel(bbs_uid){
		...
		if(result){
			location.href="/admin/bbs_freetalk/ft_delete.jsp?code=<%=code%>&uid="+bbs_uid;
			return true;
		}
	}
</script>
...
<div class="ft_list2" style="background-color:#ffd6d5;font-weight:bold;">
	...
	<a href="ft_view.jsp?page_now=<%=page_now%>&uid=<%=uid%>&field=<%=field%>&search=<%=search%>"><div class="ftlist2 ft22"  style="width:500px"><%=subject%></div></a>
...
<script>
	function alldel(){
		...
		if(result){
			location.href="/admin/bbs_freetalk/alldelete.jsp";
			return true;
		}
	}
</script>
